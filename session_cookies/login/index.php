...
<div class="grid">
    ...
    <form action="/session_cookies/login/login.php" method="POST" class="form login">
        ...
        <p class="text--center text--warning">
            <?=$_COOKIE['acesso_banco'] . $_COOKIE['acesso_login']?>
        </p>
    ...
    <p class="text--center"><a href="/session_cookies/register/index.php">Sign up now</a>
        <svg class="icon">
